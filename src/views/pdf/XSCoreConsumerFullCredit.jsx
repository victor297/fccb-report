...
const XSCoreConsumerFullCredit = () => (
  <Document>
        ...
        <View style={styles.enquiryheader}>
          ...
          <View style={styles.firstCentralconsumerscoreGrid}>
            <View style={styles.firstCentralconsumerscoreRow}>
              ...
              <Text style={styles.firstCentralconsumerscorevalue}>0 </Text>
            ...
            <View style={styles.firstCentralconsumerscoreRow}>
              ...
              <Text style={styles.firstCentralconsumerscorevalue}>01111111111 </Text>
            </View>
            <View style={styles.firstCentralconsumerscoreRow}>
            ...
            <View style={styles.firstCentralconsumerscoretable}>
              ...
              <View style={styles.firstCentralconsumerscoretableRow}>
                <View style={styles.firstCentralconsumerscoretableCol}>
                  <Text style={styles.firstCentralconsumerscoretableCell}>{`11/02/2025`}</Text>
                </View>
                 <View style={styles.firstCentralconsumerscoretableCol}>
                   <Text style={styles.firstCentralconsumerscoretableCell}>{`Not Matured For Scoring`}</Text>
                </View>
                <View style={styles.firstCentralconsumerscoretableCol}>
                    <Text style={styles.firstCentralconsumerscoretableCell}>{`HIGH RISK`}</Text>
                </View>
                </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.enquiryinputdetailsGrid}>
          <View style={styles.enquiryinputdetailsRow}>
            ...
            <Text style={styles.enquiryinputdetailsvalue}>{new Date().toLocaleDateString()}</Text>
          </View>
          <View style={styles.enquiryinputdetailsRow}>
            <Text style={styles.enquiryinputdetailslabel}>Enquiry Type</Text>
            <Text style={styles.enquiryinputdetailsvalue}>Credit Check</Text>
          </View>
          <View style={styles.enquiryinputdetailsRow}>
            <Text style={styles.enquiryinputdetailslabel}>Subscriber Name</Text>
            <Text style={styles.enquiryinputdetailsvalue}>Sample Bank Ltd</Text>
          </View>
          <View style={styles.enquiryinputdetailsRow}>
            <Text style={styles.enquiryinputdetailslabel}>Subscriber User Name</Text>
            <Text style={styles.enquiryinputdetailsvalue}>John Smith</Text>
          </View>
          <View style={styles.enquiryinputdetailsRow}>
            <Text style={styles.enquiryinputdetailslabel}>Enquiry Input</Text>
            <Text style={styles.enquiryinputdetailsvalue}>BVN12345678</Text>
          </View>
          <View style={styles.enquiryinputdetailsRow}>
            <Text style={styles.enquiryinputdetailslabel}>Enquiry Reason</Text>
            <Text style={styles.enquiryinputdetailsvalue}>New Credit Application</Text>
          </View>
          <View style={styles.enquiryinputdetailsRow}>
            <Text style={styles.enquiryinputdetailslabel}>Matching Rate</Text>
            <Text style={styles.enquiryinputdetailsvalue}>100%</Text>
          </View>
        </View>
      </View>
