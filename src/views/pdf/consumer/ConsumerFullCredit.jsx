...
const ConsumerFullCredit = ({ data }) => {
  ...
  console.log("IdentificationHistory:", identificationHistory[0][0]);
  ...
  const formatValue = (value) => value ?? null; // Utility function to handle null, undefined, or empty strings
  ...
  const dynamicMonths = Object.values(AccountMonthlyPaymentHistoryHeader ?? {}).slice(3)?.map(month => month.replace('\n', ' '))?.reverse();
          ...
          <Page size="A4" style={styles.page}>
            ...
            <View style={styles.header} fixed>
              ...
              <View style={styles.addressheader}>
                <Text>Consumer Credit Report - Detailed</Text>
              ...
              <View style={styles.CreditAccountSummaryenquiryheader}>
                <View style={styles.CreditAccountSummarydetailsGrid}>
                  ...
                  <View style={styles.CreditAccountSummarydetailRow}>
                    ...
                    <Text style={styles.CreditAccountSummaryvalue}>{CreditAccountSummary?.TotalDishonouredAmount1}</Text>
                  </View>
                  <View style={styles.CreditAccountSummarydetailRow}>
              ...
              <View style={styles.CreditAccountRatingenquiryheader}>
                <View style={styles.CreditAccountRatingdetailsGrid}>
                  ...
                  <View style={styles.CreditAccountRatingdetailRow}>
                    ...
                    <Text style={styles.LatestGuarantorDetailsvalue}>{GuarantorDetails.GuarantorPENCOMIDNo || null}</Text>
                  </View>
                  ...
                  <View style={styles.CreditAccountRatingdetailRow}>
                    ...
                    <Text style={styles.LatestGuarantorDetailsvalue}>{GuarantorDetails.GuarantorDateOfBirth || null}</Text>
                  </View>

                  <View style={styles.CreditAccountRatingdetailRow}>
                    <Text style={styles.LatestGuarantorDetailslabel}>Home Telephone</Text>
                    <Text style={styles.LatestGuarantorDetailsvalue}>{GuarantorDetails.GuarantorHomeTelephone || null}</Text>
                    <Text style={styles.LatestGuarantorDetailslabel}>Work Telephone</Text>
                    <Text style={styles.LatestGuarantorDetailsvalue}>{GuarantorDetails.GuarantorworkTelephone || null}</Text>
                  </View>
            ...
            <View style={styles.section}>
              ...
              <Text style={styles.sectionDescription}>
                This section includes a list of all Employment Information presented on the Credit/Loan applications.        </Text>
              ...
              {employmentHistory.map((record, index) => (
                <View key={index} style={styles.employmenthistorytableRow}>
                  <View style={[styles.employmenthistorytableCol, styles.employmenthistorytableColFirst]}>
                    <Text style={styles.employmenthistorytableCell}>{record?.UpDateOnDate}</Text>
                  </View>
                  <View style={styles.employmenthistorytableCol}>
                    <Text style={styles.employmenthistorytableCell}>{record?.EmployerDetail}</Text>
                  </View>
                  <View style={styles.employmenthistorytableCol}>
                    <Text style={styles.employmenthistorytableCell}>{record?.Occupation}</Text>
                  </View>
                </View>
              ))}
            </View>
...
export default ConsumerFullCredit;